...
router.get("/partialsmain/:url", (req, res) =>
    res.render("main/partials/" + req.params.url))

router.get("/main/componentes/:url", (req, res) =>
    res.render("main/componentes/" + req.params.url))

router.get("/user", (req, res) =>
    res.render("user/layout"))

router.get("/token", (req, res) =>
   res.redirect('/#/' + jwt.sign({ usuario: req.user}, secret, { expiresIn: '1h' }) + '/'))
...
router.get("/partialsadmin/:url", (req, res) =>
    res.render("admin/partials/" + req.params.url))
